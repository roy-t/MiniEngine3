...
internal sealed class WavefrontMaterialProcessor : ManagedContentProcessor<IMaterial, MaterialContent, MaterialLoaderSettings>
{
    ...
    protected override void WriteSettings(ContentId id, MaterialLoaderSettings settings, ContentWriter writer)
    {
        writer.Write(settings);
    }

    protected override void WriteBody(ContentId id, MaterialLoaderSettings settings, ContentWriter writer, IReadOnlyVirtualFileSystem fileSystem)
    {
    ...
    protected override MaterialLoaderSettings ReadSettings(ContentId id, ContentReader reader)
    {
        return reader.ReadMaterialSettings();
    }

    protected override IMaterial ReadBody(ContentId id, MaterialLoaderSettings settings, ContentReader reader)
    {        
    ...
    public override MaterialContent Wrap(ContentId id, IMaterial content, MaterialLoaderSettings settings, ISet<string> dependencies)
    {
