...
public sealed partial class BoundsSystem : ISystem, IDisposable
{
    ...
    public void OnSet()
    {
        if (this.DebugFrameService.ShowBounds)
        {
            ...
            var viewProjection = camera.GetInfiniteReversedZViewProjection(in cameraTransform, this.FrameService.CurrentCameraJitter); // TODO: is this OK for bounds, or do we need the other one?
