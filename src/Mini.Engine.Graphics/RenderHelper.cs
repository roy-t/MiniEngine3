...
public class RenderHelper
{
    ...
    public void Render(DeviceContext context, ISurface texture, int x, int y, int width, int height)
    {
    ...
    public void RenderFXAA(DeviceContext context, ISurface texture, int x, int y, int width, int height)
    {
    ...
    private void Render(DeviceContext context, ISurface texture)
    {
